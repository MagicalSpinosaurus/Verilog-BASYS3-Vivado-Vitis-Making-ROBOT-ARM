...
HD_PWD='/home/user1/workspace_ondevice_2/SoC/robot_arm/robot_arm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log robot_arm_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source robot_arm_wrapper.tcl -notrace
