...
HD_PWD='/home/user1/workspace_ondevice_2/SoC/robot_arm/robot_arm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log robot_arm_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source robot_arm_wrapper.tcl
